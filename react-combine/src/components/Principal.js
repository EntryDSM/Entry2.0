                    ...
                    <table id="table">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td rowSpan="2" className="meisterCell"><strong>마이스터 인재전형</strong></td>
                                <td colSpan="2"><strong>사회통합 전형</strong></td>
                            </tr>
                            <tr>
                                <td className="width3cm"><strong>기회 균등</strong></td>
                                <td className="width3cm"><strong>사회 다양성</strong></td>
                            </tr>
                            <tr>
                                <td className="width1cm"><strong>대전시 교육청 관내</strong></td>
                                <td></td>
                                <td></td>
                                <td></td>
                            </tr>
                            <tr>
                                <td className="width1cm"><strong>대전시 교육청 관외</strong></td>
                                <td></td>
                                <td></td>
                                <td></td>
                            </tr>
