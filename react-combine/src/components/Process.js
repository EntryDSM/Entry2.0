        ...
        return (
            ...
            <div>
                <svg id="svg">
                    ...
                    <circle className="point" id="point_step2" cx="60" cy="100" r="16" strokeWidth="2" />
                    <circle className="point" id="point_step3" cx="60" cy="180" r="16" strokeWidth="2" />
                    <circle className="point" id="point_step4" cx="60" cy="260" r="16" strokeWidth="2" />
                    <circle className="point" id="point_step5" cx="60" cy="340" r="16" strokeWidth="2" />
                    <circle className="point" id="point_step6" cx="60" cy="420" r="16" strokeWidth="2" />
                    <circle className="point" id="point_step7" cx="60" cy="500" r="16" strokeWidth="2" />
