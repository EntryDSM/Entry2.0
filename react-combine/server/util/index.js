exports.calculateScore = function (data, graduateType, applyType) {
...
exports.calculateAttendent = function (data, graduateType) {
    if (graduateType == 'black') {
        return 15;
    }
...
exports.calculateVolunteer = function (data, applyType) {
    var score, minus, div;
